...
<%@ include file = "header.html" %>
  ...
  <!-- homepage section starts here -->
        <section class="homepage-box">  
          <h1>Leesoft Laundry Terms and Conditions</h1> 
...
<div class="terms">
  ...
  <h1>Welcome to the Leesoft Laundry Website</h1>
    
   
  
  <p>These terms and conditions govern your use of the Leesoft Laundry website
   and any related services provided by Leesoft Laundry. By accessing or using the Website, you agree to be bound
    by these Terms.
  </p>
  ...
  <h1>License.</h1>
   ...
   <p>  
  Subject to your compliance with these Terms, Leesoft Laundry grants you a limited, non-exclusive, non-sublicensable,
   ...
   Services, in each case solely for your personal, non-commercial use. Any rights not expressly granted
    herein are reserved by Leesoft Laundry.
   </p>
  ...
  <p>
    (i) The Website and its original content, features, and functionality are owned by Leesoft Laundry and are 
 ...
 <h1> Text Messaging.</h1>
  ...
  <p> By creating an Account, you agree that the Services may send you text (SMS) messages as part of the 
    ...
    from Leesoft Laundry at any time. You acknowledge that opting out of receiving text (SMS) messages may 
  ...
  <h1>Payment</h1>
   ...
   <p> 
    (i) Cancellations made within hours of the scheduled com.kipcollo.controller.service may be subject to a cancellation fee. <br>
   ...
   <p>
    (i) If you have any questions about these Terms, please contact us at wilma@gmail.com <br>

     (ii) By using the Leesoft Laundry website, you signify your acceptance of these Terms and agree to comply with them. 
   </p>
